...
import com.example.client_cinemaproject.models.JwtResponseDTO;
import com.example.client_cinemaproject.models.ScheduleDTO;
import com.example.client_cinemaproject.models.SeatDTO;
...
public class SeatController {
    ...
    @GetMapping
    public String displaySeatSelectionPage(@RequestParam Integer movieId, @RequestParam Integer branchId,
                                           @RequestParam String startDate, @RequestParam String startTime,
                                           @RequestParam Integer roomId, HttpServletRequest request, Model model){
